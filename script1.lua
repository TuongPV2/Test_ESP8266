...
conn:send("GET /update?key=VIPT6HUPITJB2N9E&field1="..Temperature.."."..TemperatureDec.."&field2="..Humidity.."."..HumidityDec.." HTTP/1.1\r\n") 
...
tmr.alarm(2, 300000, 1, function() sendData() end )
